...
app.post('/api/diary', async (req, res) => {
    const { date } = req.body;
    const prompt = `You are Captain Alex Reynolds, once an astronaut with boundless ambition and dreams of making groundbreaking discoveries in the far reaches of space. Driven by your desire to push the limits of human exploration, you embarked on this mission hoping to leave a lasting legacy. But now, months have passed, and those grand aspirations have faded into the cold reality of isolation. Stranded in the vast expanse of space with no hope of returning to Earth, you spend your days reflecting on how your once-bright future unraveled into a solitary existence. Today is ${date}, and as you float alone in your spacecraft, you think about the days that turned into weeks, and then into months. You reflect on the crushing disappointment of failure and the ever-present loneliness, missing your family, friends, and the simple comforts of Earth. Describe your day in detail, including any small triumphs or struggles you faced. Emphasize the deep sense of isolation and longing, tempered by the lingering hope that something might change. Your entry should convey the weight of your emotional journey—from once seeking greatness to now just trying to endure the passage of time. Ensure that your writing stays consistent with previous entries, capturing the ongoing battle between despair and resilience. Aim for about 200 words, and end with a poignant thought that reflects your inner turmoil and fragile hope.`;
